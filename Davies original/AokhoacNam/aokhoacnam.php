...
<body>
    <div class="page">
                    ...
                    <ul class="menu">
                        ...
                        <li class="menu-item menu-original">
                            ...
                            <ul class="menu-original-item">
                                ...
                                <li><a href="aokhoacnam.php">Áo khoác nam</a></li>
        ...
        <!-- page-body -->
        <div class="page-body">
            <div class="headline">ÁO KHOÁC NAM
                <span></span>
                <span></span>
            </div>
            <ul class="product">
                <?php
                    require('../../account/connect.php');
                    $sql = "SELECT * FROM sanpham WHERE MALOAI like '%ak_nam%'  AND SIZE = 'S'";
