...
<head>
    ...
    <title>DSW GREEN BOMBER VARSITY JACKET</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSW GREEN BOMBER VARSITY JACKET%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO VARSITY JACKET LOCAL BRAND MÀU XANH GREEN BOMBER - LIMITED</p>
