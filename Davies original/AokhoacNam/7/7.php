...
<head>
    ...
    <title>DSW JACKET DAVIESISM CLASSIC SS22</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSW JACKET DAVIESISM CLASSIC SS22%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO KHOÁC LOCAL BRAND ĐẸP KAKI DAVIESISM CLASSIC SS22 JACKET</p>
                            ...
                            <div class="search-contact">
                                Hoặc trả sau 93.000₫ x 3 kỳ với Fundiin Tìm hiểu(?)
                            </div>
                            <ul class="item-note">
