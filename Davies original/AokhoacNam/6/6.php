...
<head>
    ...
    <title>DSW BOMBER JACKET TACTICAL</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSW BOMBER JACKET TACTICAL%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <h6>ÁO KHOÁC BOMBER LOCAL BRAND ĐẸP MÀU ĐEN DÙ TACTICAL JACKET</h6>
