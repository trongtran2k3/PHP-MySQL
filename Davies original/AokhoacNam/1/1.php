...
<head>
    ...
    <title>DSW HOODED BASIC JACKET - ĐEN</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSW HOODED BASIC JACKET - ĐEN%'";
                ...
                <div class="body-left">
                    <div class="body-left-info">
                        <div class="body-left-info-img">
                            ...
                            <div>
                                <img id="img-smallsize" src="mau1-1.webp" alt="">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO KHOÁC LOCAL BRAND ĐẸP FORM RỘNG, CÓ MŨ HOODED BASIC JACKET</p>
