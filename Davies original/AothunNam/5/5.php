...
<head>
    ...
    <title>DSW TEE DAVIES X DANANG DRAGONS SS22</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSW TEE DAVIES X DANANG DRAGONS SS22%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO THUN LOCAL BRAND DAVIES X DANANG DRAGONS SS22 LIMITED TEE</p>
