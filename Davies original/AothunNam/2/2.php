...
<head>
    ...
    <title>DSW TEE VITAMIN DEE</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSW TEE VITAMIN DEE%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO THUN LOCAL BRAND ĐẸP MÀU TRẮNG VITAMIN DEE TEE</p>
                            ...
                            <div class="search-contact">
                                Hoặc trả sau 99.333₫ x 3 kỳ với Fundiin Tìm hiểu(?)
                            </div>
                            <ul class="item-note">
