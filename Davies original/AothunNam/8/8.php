...
<head>
    ...
    <title>DSW TEE CAMOU TYPE LOGO - BLACK</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSW TEE CAMOU TYPE LOGO - BLACK%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO THUN LOCAL BRAND DAVIES WHITE CAMOU TYPE LOGO TEE</p>
                                <h2><?php echo $row['TENSP'];?></h2>
                                <p>ÁO THUN NAM STREETWEAR / DAVIES BRAND</p>
                            </div>
    ...
    <div class="page">
        ...
        <div class="header">
            ...
            <div class="header-top">
                <!-- logo -->
                <div class="logo">
                    <div class="shop-name"><h3><a href="../../../index.html" style="text-decoration: none;color: white;">MAMITI</a></h3></div>
                    <a href="../../../index.html">
                        <img id="mmt" src="../../../Mamiti.png" alt="">
                    </a>
                </div>
                ...
                <!-- Sign in sign up -->
                <div class="account">
                    <button ><a class="gradientButton" href="../../../account.html">Account</a></button>
                </div>
            </div>
            <!-- animation gradient -->
            <div class="gradient"></div>
            ...
            <div class="header-bottom">
                ...
                <nav class="container">
                    <ul class="menu">
                        <li class="menu-item menu-all">
                            <a id="ori-a" href="../../../allin.html">TẤT CẢ SẢN PHẨM</a>
                        </li>
                        <li class="menu-item menu-original">
                            <a id="ori-a" href="../../../Davies original/daviesoriginal.html">
                                DAVIES ORIGINAL
                                <!-- dropdown -->
                                <b class="caret hidden-xs"></b>
                            </a>
                            <ul class="menu-original-item">
                                <li><a href="aothunnam.html">Áo thun nam</a></li>
                                <li><a href="../../../Davies original/AokhoacNam/aokhoacnam.html">Áo khoác nam</a></li>
                                <li><a href="../../../Davies original/Hoodie/hoodie.html">Hoodie/SWE</a></li>
                                <li><a href="../../../Davies original/QuanNam/quannam.html">Quần nam</a></li>
                            </ul>
                        </li>
                        <li class="menu-item menu-brand">
                            <a id="ori-a" href="../../../Davies brand/daviesbrand.html">DAVIES BRAND</a>
                            <ul class="menu-brand-item" type="none">
                                <li><a href="../../../Davies brand/AothunNu/aothunnu.html">Áo thun nữ</a></li>
                                <li><a href="../../../Davies brand/AoKhoacNu/aokhoacnu.html">Áo khoác nữ</a></li>
                                <li><a href="../../../Davies brand/HoodieSWENu/hoodienu.html">Hoodie/SWE nữ</a></li>
                                <li><a href="../../../Davies brand/AoCroptop/croptop.html">Áo Croptop</a></li>
                            </ul>
                        </li>
                        <li class="menu-item menu-lab">
                            <a id="ori-a" href="../../../Davies Lab/davieslab.html">DAVIES LAB</a>
                        </li>
                        <li class="menu-item menu-pay">
                            <a id="ori-a" href="">KIỂM TRA ĐƠN HÀNG</a>
                        </li>
                        <li class="menu-item menu-work">
                            <a id="ori-a" href="../../../FPT-SoftWare/fptsoftware.html">TUYỂN DỤNG IT</a>
                        </li>
                    </ul>
                </nav>
            </div>
        ...
        <!-- page-body -->
        <div class="page-body">
            <div class="headline">DSW TEE FLOWER
                <span></span>
                <span></span>
            </div>
            <div class="body">
                <div class="body-left">
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO THUN LOCAL BRAND ĐẸP MÀU TRẮNG FLOWER TEE</p>
                                <h2>DSW TEE FLOWER</h2>
                                <p>ÁO THUN NAM STREETWEAR / DAVIES BRAND</p>
                            </div>
                            <div class="product-price">
                                <strong style="font-size: 24px;">189.000₫</strong>
                                <del>320.000₫</del>
                            </div>
                            <div class="search-contact">
                                Hoặc trả sau 73.000₫ x 3 kỳ với Fundiin Tìm hiểu(?)
                            ...
                            <div class="check">
                                <form action="#">
                                    <ul class="size" style="padding: 10px 0px 20px; list-style: none;text-decoration: none;display: flex; width: 238px;justify-content: space-between;">
                                        <li style="width: 50%;">Kích thước</li>
                                        <li style="width: 50%;display: flex; justify-content: space-evenly;">
                                            <span style="padding: 4px 10px; border: 1px solid black; background-color: white;color: black;"> m</span>
                                            <span style="padding: 4px 10px; border: 1px solid black; background-color: white;color: black;">l</span>
                                            <span style="padding: 4px 10px; border: 1px solid black; background-color: white;color: black;">xl</span>
                                        </li>
                                    </ul>
                                    <ul class="count" style="list-style: none;text-decoration: none;display: flex; width: 250px;justify-content: space-between;">
                                        <li style="width: 50%;">Số lượng</li>
                                        <li style="width: 50%;display: flex;">
                                            <button type="button" onclick="down()" style="padding: 5px 10px;">-</button>
                                            <input style="width: 50px;text-align: center;" type="text" name="count" id="count" value="1" maxlength="4">
                                            <button type="button" onclick="up()" style="padding: 5px 10px;">+</button>
                                            <script>
                                                function up() {
                                                    var x = document.getElementById("count").value;
                                    ...
                                    <div class="button" style="display: flex;flex-wrap: wrap;padding: 20px 0px;">
                                        <div><button class="btn" style="width: 420px; background-color: white;color: black; padding: 5px;">MUA HÀNG</button></div>
                                        <div style="padding: 5px 0px;"><button class="btn" style="width: 420px; background-color: white;color: black; padding: 5px;">MUA HÀNG TRÊN TIKTOK SHOP</button></div>
                                        <div><button class="btn" style="width: 420px; background-color: white;color: black; padding: 5px;">MUA HÀNG TRÊN SHOPEE</button></div>
                                    </div>
                                </form>
                            </div>
                        </div>
