...
<head>
    ...
    <title>DSW TEE WAFFLE KNIT</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSW TEE WAFFLE KNIT%'";
                    ...
                    <div class="body-left-info">
                        <div class="body-left-info-img">
                            ...
                            <div>
                                ...
                                <img id="img-smallsize" src="mau5.webp" alt="">
                            </div>
                        </div>
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO THUN LOCAL BRAND ĐẸP FORM RỘNG TEE WAFFLE KNIT</p>
