...
<body>
    <div class="page">
                ...
                <nav class="container">
                    <ul class="menu">
                        ...
                        <li class="menu-item menu-original">
                            <a id="ori-a" href="daviesoriginal.php">
                                DAVIES ORIGINAL
                                <!-- dropdown -->
        ...
        <!-- page-body -->
        <div class="page-body">
            <div class="headline">DAVIES ORIGINAL
                <span></span>
                <span></span>
            </div>
            <ul class="product">
                <?php
                    require('../account/connect.php');
                    $sql = "SELECT * FROM sanpham WHERE (MALOAI like '%nam%' AND MALOAI != 'lab_nam') AND SIZE = 'S'";
