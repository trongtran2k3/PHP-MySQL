...
<head>
    ...
    <title>DSW D BASIC HOODIE</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSW D BASIC HOODIE%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>HOODIE ZIP LOCAL BRAND ÁO KHOÁC NỈ FORM RỘNG D BASIC</p>
                            ...
                            <div class="search-contact">
                                Hoặc trả sau 96.333₫ x 3 kỳ với Fundiin Tìm hiểu(?) 
                            </div>
                            <ul class="item-note">
