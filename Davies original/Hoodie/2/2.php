...
<head>
    ...
    <title>DSW HOODIE COMMUNITY</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSW HOODIE COMMUNITY%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO KHOÁC HOODIE LOCAL BRAND ĐẸP COMMUNITY</p>
                            ...
                            <div class="search-contact">
                                Hoặc trả sau 163.333₫ x 3 kỳ với Fundiin Tìm hiểu(?)
                            </div>
                            <ul class="item-note">
