...
<head>
    ...
    <title>DSW HOODIE AGGRESSION RIBON</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSW HOODIE AGGRESSION RIBON%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO HOODIE NAM LOCAL BRAND DAVIES - AGGRESSION RIBON HOODIE</p>
