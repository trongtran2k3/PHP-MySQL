...
<head>
    ...
    <title>DSW BOX PANT BASIC LOGO</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSW BOX PANT BASIC LOGO%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>QUẦN DÀI LOCAL BRAND ĐEN TÚI HỘP DAVIES BOX PANT BASIC LOGO</p>
                                <h2><?php echo $row['TENSP'];?></h2>
                                <p>QUẦN NAM STREETWEAR /
                                    DAVIES BRAND</p>
                            </div>
