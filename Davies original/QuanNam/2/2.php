...
<head>
    ...
    <title>D16-Q1 TRIPED LINE PANT FLEX</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%D16-Q1 TRIPED LINE PANT FLEX%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>QUẦN DÀI DÙ TRIPED LINE PANT FLEX IN DAVIES BRAND</p>
