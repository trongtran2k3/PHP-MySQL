...
<head>
    ...
    <title>DVSL TEE DAVILLIUM LOGO</title>
</head>
...
<body>
    <div class="page">
                ...
                <nav class="container">
                    <ul class="menu">
                        ...
                        <li class="menu-item menu-lab">
                            <a id="ori-a" href="../davieslab.php">DAVIES LAB</a>
                        </li>
        ...
        <?php
            require('../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DVSL TEE DAVILLIUM LOGO%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO THUN LOCAL BRAND DAVIES - DAVILLIUM LOGO TEE (LIMITED)</p>
