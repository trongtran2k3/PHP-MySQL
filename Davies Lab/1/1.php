...
<head>
    ...
    <title>DVSL BASIC TEE WHITE</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DVSL BASIC TEE WHITE%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO THUN TRƠN LOCAL BRAND MÀU TRẮNG DVSL BASIC TEE</p>
                                <h2><?php echo $row['TENSP'];?></h2>
                                <p>ÁO IN STREETWEAR / DAVIES BRAND</p>
                            </div>
