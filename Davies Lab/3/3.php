...
<head>
    ...
    <title>DVSL HOLO ZIPPER BOX</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DVSL HOLO ZIPPER BOX%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO THUN LOCAL BRAND DAVIES - HOLO ZIPPER BOX TEE (LIMITED).</p>
