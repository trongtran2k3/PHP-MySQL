    ...
    <main>
        <div class="main_left">
            <form action="##">
                ...
                <a style="background-color: antiquewhite;" href="hoadon.php"><i class="fa-solid fa-bars"></i>  Hóa đơn</a>
            ...
            <form action="##">
                <table>
                    ...
                    <?php
                        ...
                        $stt =1;
                        $result = mysqli_query($conn,$hoadon);
                        while($row = mysqli_fetch_assoc($result)){
                            echo "<td>".$stt."</td>";
                            echo "<td>".$row['MAHD']."</td>";
                            echo "<td>".$row['NGLHD']."</td>";
                            echo "<td>".$row['MAKH']."</td>";
                            echo "<td>".$row['TOTAL']."</td>";
                            echo "<td>".$row['PTTT']."</td>";
                           ?>
                           <td><a class="btn" href="change_hd.php?id_hd=<?php echo $row['MAHD'] ?>&query=suahd">Sửa</a><a class="btn" href="dele_hd.php?id_hd=<?php echo $row['MAHD'] ?>&query=xoahd">Xóa</a></td>
                           <?php
                            echo "</tr>";
                        }
                    ?>
