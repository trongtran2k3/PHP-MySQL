    ...
    <main>
        <div class="main_left">
            <form action="##">
                ...
                <a style="background-color: antiquewhite;" href="khachhang.php"> Khách hàng</a>
            ...
            <form action="##">
                <table>
                    ...
                    <?php
                        ...
                        $result = mysqli_query($conn,$khachhang);
                        while($row = mysqli_fetch_assoc($result)){
                           ...
                           ?>
                           <td>
                                <a class="btn" href="change_kh.php?id_kh=<?php echo $row['MAKH'] ?>&query=sua_kh">Sữa</a>
                                <a class="btn" href="dele_kh.php?id_kh=<?php echo $row['MAKH'];?>&query=xoakh">Xóa</a>
                            </td>   
                           <?php
                            echo "</tr>";
                        }
                    ...
                    <tr>
                        <th style="height: 100px;" colspan="10">
                            <a style="margin-right: 50px;" class="btn" href="them_kh.php?query=them_kh">Thêm</a>
