...
<head>
    ...
    <title>DSS TEE DEVIL'S CAKE-TRẮNG</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSS TEE DEVIL'S CAKE-TRẮNG%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO THUN LOCAL BRAND ĐẸP MÀU TRẮNG DEVIL'S CAKE</p>
