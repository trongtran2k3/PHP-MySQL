...
<head>
    ...
    <title>D10-T38 CROPTOP LED TEXT</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%D10-T38 CROPTOP LED TEXT%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO CROPTOP RỘNG LOCAL BRAND DAVIES - VIOLET LED TEXT CROPTOP</p>
