    ...
    <div class="page">
                ...
                <nav class="container">
                    <ul class="menu">
                        ...
                        <li class="menu-item menu-brand">
                            <a id="ori-a" href="../daviesbrand.php">DAVIES BRAND</a>
                            <ul class="menu-brand-item" type="none">
                                ...
                                <li><a href="croptop.php">Áo Croptop</a></li>
                            </ul>
                        </li>
        ...
        <div class="page-body">
            ...
            <ul class="product">
                <?php
                    require('../../account/connect.php');
                    $sql = "SELECT * FROM sanpham WHERE MALOAI like '%cr_nu%'  AND SIZE = 'S'";
