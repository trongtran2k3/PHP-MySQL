...
<head>
    ...
    <title>D14-T33 CROPTOP RUBBER TAG</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM sanpham WHERE TENSP like '%D14-T33 CROPTOP RUBBER TAG%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO CROPTOP ÔM EO NỮ LOCAL BRAND DAVIES RUBBER TAG</p>
