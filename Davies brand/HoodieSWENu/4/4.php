...
<head>
    ...
    <title>DSS HOODIE D CARTOON</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSS HOODIE D CARTOON%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO KHOÁC NỮ HOODIE MÀU TÍM LOCAL BRAND DAVIES - D CARTOON HOODIE
                                    DSS HOODIE D CARTOON</p>
                                <h2><?php echo $row['TENSP'];?></h2>
                                <p>HOODIE NỮ STREETWEAR / DAVIES BRAND</p>
                            </div>
