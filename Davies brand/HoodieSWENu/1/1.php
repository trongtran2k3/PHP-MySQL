...
<head>
    ...
    <title>DSS ZIP HOODIE BASIC</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSS ZIP HOODIE BASIC%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO KHOÁC CROPTOP HOODIE NỮ LOCAL BRAND DAVIES- BASIC ZIP HOODIE JACKET
                                    </p>
                                <h2><?php echo $row['TENSP'];?></h2>
                                <p>ÁO HOODIE NỮ STREETWEAR / DAVIES BRAND</p>
                            </div>
