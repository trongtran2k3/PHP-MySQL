...
<head>
    ...
    <title>DSS ZIP HOODIE PAINTING</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSS ZIP HOODIE PAINTING%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO KHOÁC HOODIE LOCAL BRAND DAVIES - PAINTING HOODIE JACKET
                                    </p>
