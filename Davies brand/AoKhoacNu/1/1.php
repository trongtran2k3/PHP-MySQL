...
<head>
    ...
    <title>DSS JACKET 90S - WHITE</title>
</head>
...
<body>
    <div class="page">
        ...
        <?php
            require('../../../account/connect.php');
            $sql = "SELECT * FROM SANPHAM WHERE TENSP like '%DSS JACKET 90S - WHITE%'";
                    ...
                    <div class="body-left-info">
                        ...
                        <div class="body-left-info-title">
                            <div class="body-left-info-title-name" style="padding-bottom: 15px;">
                                <p>ÁO KHOÁC DÙ LOCAL BRAND FORM RỘNG MÀU ĐEN FOREST JACKET</p>
