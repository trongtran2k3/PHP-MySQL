...
<body>
    <div class="page">
                    ...
                    <ul class="menu">
                        ...
                        <li class="menu-item menu-brand">
                            ...
                            <ul class="menu-brand-item" type="none">
                                ...
                                <li><a href="aokhoacnu.php">Áo khoác nữ</a></li>
        ...
        <!-- page-body -->
        <div class="page-body">
            <div class="headline">ÁO KHOÁC NỮ
                <span></span>
                <span></span>
            </div>
            <ul class="product">
                <?php
                    require('../../account/connect.php');
                    $sql = "SELECT * FROM sanpham WHERE MALOAI like '%ak_nu%'  AND SIZE = 'S'";
